...
{
    public partial class PerEquipmentElectricityConsumption : WebStyleBaseForEnergy.webStyleBase
    {
        private const string REPORT_TEMPLATE_PATH = "\\ReportHeaderTemplate\\PerEquipmentElectricityConsumption.xml";
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            this.OrganisationTree_ProductionLine.PageName = "PerEquipmentElectricityConsumption.aspx";                                     //向web用户控件传递当前调用的页面名称
            ...
            if (m_FunctionName == "ExcelStream")
            {
                ...
                StatisticalReportHelper.ExportExcelFile("xls", "高压设备单机电耗统计报表.xls", m_HtmlData);
            }
        }
        ...
        {
            myDataTable = PerEquipmentElectricityConsumptionService.GetEquipmentElectricityConsumption(organizationId, startDate, endDate);
