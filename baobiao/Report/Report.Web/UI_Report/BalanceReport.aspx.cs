...
{
    public partial class BalanceReport : WebStyleBaseForEnergy.webStyleBase
    {
        private const string REPORT_TEMPLATE_PATH = "\\ReportHeaderTemplate\\BalanceReport.xml";
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (m_FunctionName == "ExcelStream")
            {
                ...
                StatisticalReportHelper.ExportExcelFile("xls", "能耗平衡表.xls", m_HtmlData);
            }
        }

        [WebMethod]
        public static string GetData(string organizationId, string startDate, string endDate, decimal clinkerCoefficient, decimal cementCoefficient)
        {
            DataTable table = BalanceReportService.GetReportData(organizationId, startDate, endDate, clinkerCoefficient,cementCoefficient);
