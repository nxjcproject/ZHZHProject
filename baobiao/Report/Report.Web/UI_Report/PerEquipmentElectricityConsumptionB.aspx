<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PerEquipmentElectricityConsumptionB.aspx.cs" Inherits="Report.Web.UI_Report.PerEquipmentElectricityConsumptionB" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    ...
    <script type="text/javascript" src="/UI_Report/js/page/PerEquipmentElectricityConsumptionB.js" charset="utf-8"></script>
</head>
<body>
		                ...
		                <table>
			                <tr>
				                ...
				                <td>
                                    ...
                                    <input id="startDate" type="text" class="easyui-datebox" required="required" style="width:150px;"/>
				                </td>
                                <td>结束时间：</td>
				                <td>
                                    <%--<input id="datetime" class="easyui-datetimespinner" value="6/24/2014" data-options="formatter:formatter2,parser:parser2,selections:[[0,4],[5,7]]" style="width:180px;" />--%>
                                    <input id="endDate" type="text" class="easyui-datebox" required="required" style="width:150px;"/>
				                </td>
