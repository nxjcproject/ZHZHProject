<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProcessPVFElectricityQuantity.aspx.cs" Inherits="Report.Web.UI_Report.ProcessPVFElectricityQuantity" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    ...
    <script type="text/javascript" src="/UI_Report/js/page/ProcessPVFElectricityQuantity.js"></script>
</head>
<body>
    <div class="easyui-layout" data-options="fit:true,border:false">
        ...
        <div id="reportTable" class="easyui-panel" data-options="region:'center', border:true, collapsible:false, split:false">
            <table id="gridMain_ReportTemplate" class="easyui-treegrid" data-options="toolbar:'#toolbar_ReportTemplate',rownumbers:true,singleSelect:true" title="">
		        <thead>
			        <tr>
                        <%--<th data-options="field:'ProductLineName',width:80">产线名</th>--%>
                        <th data-options="field:'Name',width:230">项目</th>
                        ...
                        <th data-options="field:'RatioPeakB',width:80">峰期比例</th>
                        <th data-options="field:'RatioMorePeakB',width:80">尖峰期比例</th>
                        <th data-options="field:'RatioValleyB',width:80">谷期比例</th>
                        <th data-options="field:'RatioFlatB',width:80">平期比例</th>
			        </tr>
		        </thead>
            </table>
        </div>
