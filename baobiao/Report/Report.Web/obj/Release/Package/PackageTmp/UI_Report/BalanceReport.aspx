<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BalanceReport.aspx.cs" Inherits="Report.Web.UI_Report.BalanceReport" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    ...
    <script type="text/javascript" src="/UI_Report/js/page/BalanceReport.js" charset="utf-8"></script>
</head>
<body>
	            ...
	            <tr>
	                <td>
		                <table>
	                        ...
	                        <tr>
                                <td>
                                    熟料消耗系数：<input id="clinkerCoefficient" type="text" value="1.55" name="firstname" style="width:50px"/>
                                    水泥消耗系数：<input id="cementCoefficient" type="text" value="0.7955" name="firstname" style="width:50px"/>
